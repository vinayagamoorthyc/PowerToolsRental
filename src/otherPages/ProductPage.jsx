  ...
  return (
    <div>
      <div style={{background:"black", padding:"5px",position:"fixed",width:"100%",zIndex:"1"}} className='blacknav'>
        <a href='/AllProducts'><button class="Back_Btn">
          <a href='/AllProducts' class="back_icon"><svg class="svg-icon" viewBox="0 0 20 20">
          ...
          <a href='/AllProducts' class="back_text">Back</a>
        </button></a>
        </div>
